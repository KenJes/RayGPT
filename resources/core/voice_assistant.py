...
def _run_standalone():
    ...
    print("=" * 60)
    print("  🎤  RAYMUNDO / REINA — Asistente de Voz")
    print("  Di 'Raymundo' para hablar con él (Jorge)")
    print("  Di 'Reina' para hablar con ella (Dalia)")
    print("  'Cambia a Reina/Raymundo' para switchear")
